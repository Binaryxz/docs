...
def main(leads_path: str, enriquecidos_path: str, output_path: str, fonte_original: str | None) -> None:
    ...
    for _, row in planilha.iterrows():
        ...
        email = fallback.get("email") or texto(row.get("correio_eletronico")) or texto(row.get("email"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("leads", help="CSV de leads filtrados (ex.: leads_com_socios.csv)")
