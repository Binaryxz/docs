-- Junta o resultado de filtro_cnae.sql com o decisor provável de
-- socios_decisor.sql, gerando a tabela "leads_com_socios" que alimenta a
-- etapa 4 (Sherlocker opcional) e a etapa 5 (enrich_leads.py /
-- agentic_enrich.py / enrich_leads_gratis.py) e, no final,
...
-- e `meu_projeto.prospeccao.socios_decisor`), e exporte esta SELECT como
