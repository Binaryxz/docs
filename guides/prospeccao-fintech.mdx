...
| Secundário | 64.61-1-00 | Holdings de instituições financeiras |
| Secundário | 64.92-1-00 | Securitização de créditos |
| Secundário | 66.19-3-05 | Operadoras de cartões de débito |
| Secundário | 66.19-3-06 | Casas de câmbio |
| Secundário | 66.12-6-03 | Corretoras de câmbio |

### Regra do filtro

Um CNPJ entra na lista quando:

- **pelo menos 60% dos 13 CNAEs acima** (ou seja, 8 de 13) estão registrados nele, entre CNAE principal e secundários; **ou**
- a razão social ou o nome fantasia contém "fintech".

```sql filtro_cnae.sql
DECLARE cnaes_alvo ARRAY<STRING> DEFAULT [
  '7490104', '6203100', '6201501', '8299799', '6209100',
  '6619399', '6619302', '8291100',
  '6461100', '6492100', '6619305', '6619306', '6612603'
];
