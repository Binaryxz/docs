...
- **a soma de pesos dos CNAEs acima que ele tem** (CNAE principal + secundários) é **pelo menos 60% da soma total de pesos** (23 no total: 10 códigos de peso 2 + 3 de peso 1 → precisa de pelo menos 14 pontos); **ou**
...
<Tip>
  Ajuste o limiar (`limiar_percentual`), os pesos ou a lista de CNAEs conforme o ICP mudar; nenhuma outra etapa do fluxo depende desses valores.
</Tip>
